...
const en = {
  ...
  settings: {
    ...
    mapTileProvider: 'Map style',
    mapTileProviderDescription: 'Choose the map appearance for light and dark themes.',
    mapTileProviders: {
      esri: 'Esri Gray (Recommended)',
      osm: 'OpenStreetMap Standard',
      carto: 'CARTO Light/Dark (requires API key)',
      google: 'Google Maps',
      esriStreet: 'Esri Street',
      esriImagery: 'Esri Satellite',
    ...
    mapTheme: 'Map theme',
    mapThemeDescription: 'Choose how the map colors adapt to the app theme.',
    mapThemeModes: {
      system: 'System',
      light: 'Light',
      dark: 'Dark',
    ...
    mapApiKeyDescription:
      'Required for some providers (e.g. CARTO). Leave empty if your provider does not need it.',
    mapApiKeyPlaceholder: 'API key (optional)',
    zoomSettings: 'Zoom',
    pageZoom: 'Page zoom',
