...
const tr = {
  ...
  settings: {
    ...
    mapTileProvider: 'Harita stili',
    mapTileProviderDescription: 'Açık ve koyu tema için harita görünümünü seçin.',
    mapTileProviders: {
      esri: 'Esri Gri (Önerilen)',
      osm: 'OpenStreetMap Standart',
      carto: 'CARTO Açık/Koyu (API anahtarı gerektirir)',
      google: 'Google Maps',
      esriStreet: 'Esri Sokak',
      esriImagery: 'Esri Uydu',
      esriTopo: 'Esri Topografik',
    ...
    mapThemeDescription: 'Harita renklerinin uygulama temasına nasıl uyum sağlayacağını seçin.',
    mapThemeModes: {
      system: 'Sistem',
      light: 'Açık',
      dark: 'Koyu',
    ...
    mapSettings: 'Harita',
    mapApiKey: 'Harita API anahtarı',
    mapApiKeyDescription:
      'Bazı sağlayıcılar için gereklidir (örn. CARTO). Gerekli değilse boş bırakın.',
    mapApiKeyPlaceholder: 'API anahtarı (isteğe bağlı)',
