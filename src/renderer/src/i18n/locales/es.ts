...
const es = {
  ...
  settings: {
    ...
    mapTileProvider: 'Estilo del mapa',
    mapTileProviderDescription: 'Elija la apariencia del mapa para temas claro y oscuro.',
    mapTileProviders: {
      esri: 'Esri Gris (Recomendado)',
      osm: 'OpenStreetMap Estándar',
      carto: 'CARTO Claro/Oscuro (requiere clave API)',
      google: 'Google Maps',
    ...
    mapThemeDescription: 'Elige cómo los colores del mapa se adaptan al tema.',
    mapThemeModes: {
      system: 'Sistema',
      light: 'Claro',
      dark: 'Oscuro',
    ...
    mapSettings: 'Mapa',
    mapApiKey: 'Clave API del mapa',
    mapApiKeyDescription:
      'Necesaria para algunos proveedores (ej. CARTO). Déjala vacía si no la necesitas.',
    mapApiKeyPlaceholder: 'Clave API (opcional)',
    ...
    telemetryDescription:
      'Al iniciar la aplicación se envían un identificador de instalación anónimo, la versión, la plataforma y el idioma de la interfaz para contar usuarios activos. Microsoft obtiene un país y una ciudad aproximados a partir de la IP de conexión. No se envían datos de terremotos.',
