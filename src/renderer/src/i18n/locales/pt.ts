...
const pt = {
  ...
  settings: {
    ...
    mapTileProvider: 'Estilo do mapa',
    mapTileProviderDescription: 'Escolha a aparência do mapa para temas claro e escuro.',
    mapTileProviders: {
      esri: 'Esri Cinza (Recomendado)',
      osm: 'OpenStreetMap Padrão',
      carto: 'CARTO Claro/Escuro (requer chave API)',
      google: 'Google Maps',
    ...
    mapThemeDescription: 'Escolha como as cores do mapa se adaptam ao tema.',
    mapThemeModes: {
      system: 'Sistema',
      light: 'Claro',
      dark: 'Escuro',
    ...
    mapSettings: 'Mapa',
    mapApiKey: 'Chave API do mapa',
    mapApiKeyDescription:
      'Necessária para alguns provedores (ex. CARTO). Deixe vazio se não precisar.',
    mapApiKeyPlaceholder: 'Chave API (opcional)',
    ...
    telemetryDescription:
      'Ao iniciar a aplicação, são enviados um identificador de instalação anónimo, a versão, a plataforma e o idioma da interface para contar utilizadores ativos. A Microsoft obtém um país e uma cidade aproximados a partir do IP da ligação. Não são enviados dados de terramotos.',
