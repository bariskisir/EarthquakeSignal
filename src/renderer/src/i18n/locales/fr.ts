...
const fr = {
  ...
  settings: {
    ...
    mapTileProvider: 'Style de carte',
    mapTileProviderDescription:
      "Choisissez l'apparence de la carte pour les thèmes clair et sombre.",
    mapTileProviders: {
      esri: 'Esri Gris (Recommandé)',
      osm: 'OpenStreetMap Standard',
      carto: 'CARTO Clair/Sombre (clé API requise)',
      google: 'Google Maps',
    ...
    mapThemeDescription: 'Choisissez comment les couleurs de la carte s’adaptent au thème.',
    mapThemeModes: {
      system: 'Système',
      light: 'Clair',
      dark: 'Sombre',
    ...
    mapApiKeyDescription:
      'Requise pour certains fournisseurs (ex. CARTO). Laissez vide si inutile.',
    mapApiKeyPlaceholder: 'Clé API (facultatif)',
